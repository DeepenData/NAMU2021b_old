...
df_metabolitos = df[metabolites_columns] # Hace un subset solo con columnas de metabolitos
...
metabolitos_pairplot = sns.pairplot(no_outliers, diag_kind="kde")
