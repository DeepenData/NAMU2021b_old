...
left_right_panel <- ggarrange(right_panel, left_panel, NULL, ncol = 3,  widths= c(.4,.6,1))
...
```{r fig.height=13, fig.width=10}
ggsave(file="left_right_panel.png", plot=left_right_panel, width=10, height=13, dpi = 500)
...
optimality_values %>% write_csv('optimality_values.csv')
```
